...
namespace 图片压缩
{
    class PicThumbnail
    {
        ...
        public static Image GetThumbnailImagepercent(Image image, int percent)
        {
            Size msize = GetImageSize(image, percent);
            return GetThumbnailImage(image, msize.Width, msize.Height);
        }
